...
`${GOPATH}/src/github.com/dpattee/speedbeat`
...
```
git remote set-url origin https://github.com/dpattee/speedbeat
...
in the same directory with the name speedbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/dpattee/speedbeat
git clone https://github.com/dpattee/speedbeat ${GOPATH}/src/github.com/dpattee/speedbeat
```
